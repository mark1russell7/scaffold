...
export declare const generators: import("../schema/validators.js").GeneratorRegistry<{
    readonly __$scaffold_meta_01944a8c7d00$__: {
        readonly type: import("../schema/types.js").FSType.Directory;
        readonly name: "{{packageName}}";
    };
    readonly "package.json": {
        readonly __$scaffold_meta_01944a8c7d00$__: {
            readonly type: import("../schema/types.js").FSType.File;
            readonly generator: import("../schema/types.js").Generator.Cue;
            readonly feature: import("../schema/types.js").Feature.NPM;
    ...
    readonly "tsconfig.json": {
        readonly __$scaffold_meta_01944a8c7d00$__: {
            readonly type: import("../schema/types.js").FSType.File;
            readonly generator: import("../schema/types.js").Generator.Cue;
            readonly feature: import("../schema/types.js").Feature.TS;
    ...
    readonly ".gitignore": {
        readonly __$scaffold_meta_01944a8c7d00$__: {
            readonly type: import("../schema/types.js").FSType.File;
            readonly generator: import("../schema/types.js").Generator.Cue;
            readonly feature: import("../schema/types.js").Feature.Core;
    ...
    readonly "dependencies.json": {
        readonly __$scaffold_meta_01944a8c7d00$__: {
            readonly type: import("../schema/types.js").FSType.File;
            readonly generator: import("../schema/types.js").Generator.Template;
            readonly feature: import("../schema/types.js").Feature.Cue;
    ...
    readonly "vitest.config.ts": {
        readonly __$scaffold_meta_01944a8c7d00$__: {
            readonly type: import("../schema/types.js").FSType.File;
            readonly generator: import("../schema/types.js").Generator.TsMorph;
            readonly feature: import("../schema/types.js").Feature.Vitest;
