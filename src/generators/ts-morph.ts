 ...
 */
export const generateVitestConfig: GeneratorFn = async (
  _path: string,
 ...
 */
export const generateIndexTs: GeneratorFn = async (
  _path: string,
 ...
 */
export const generateTestFile: GeneratorFn = async (
  path: string,
  context: GeneratorContext
): Promise<string> => {
  const project = new Project({ useInMemoryFileSystem: true });
 ...
 */
export const generateRegisterTs: GeneratorFn = async (
  _path: string,
  _context: GeneratorContext
): Promise<string> => {
  const project = new Project({ useInMemoryFileSystem: true });
